...
def pressure_finding_func(guess_pressure: npt.ArrayLike,
...
def pressure_finding_func_der(guess_pressure: npt.ArrayLike,
                              U_cart: npt.ArrayLike, 
                               metric: Metric,
                                sim_params: SimParams,
                                grid_info: GridInfo,
...
def three_vel_mag_squared(guess_pressure,
                  U_cart, 
                    metric: Metric,
                    sim_params: SimParams,
                    grid_info: GridInfo,
...
def boost_guess(guess_pressure,
                  U_cart, 
                    metric: Metric,
                    sim_params: SimParams,
                    grid_info: GridInfo,
...
def construct_primitives_from_guess(guess_pressure:npt.ArrayLike,
    ...
    # guess_pressure = np.clip(np.exp(guess_pressure), a_min=1E-9, a_max=None)
